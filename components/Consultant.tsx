    ...
    <section className="py-20 sm:py-32 bg-surface relative overflow-hidden" aria-labelledby="consultant-heading">
      <div className="max-w-7xl mx-auto px-6 sm:px-4">
        <AnimatedSection className="text-center mb-12 sm:mb-16">
          <h2 id="consultant-heading" className="text-2xl sm:text-5xl font-extrabold text-accent tracking-tight">
            {consultant.title}
          </h2>
        </AnimatedSection>

        <AnimatedSection delay={100} className="max-w-4xl mx-auto">
          <div className="bg-background rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-12 flex flex-col md:flex-row gap-8 items-center border border-accent/5 hover:shadow-lg transition-shadow duration-300">
            {/* Photo */}
            ...
            <div className="flex-grow text-center md:text-left">
              ...
              <ul className="flex flex-wrap justify-center md:justify-start gap-3 mb-6">
                {consultant.credentials.map((cred, idx) => (
                  <li
                    key={idx}
                    className="flex items-center gap-1.5 text-xs sm:text-sm text-accent/80 bg-surface px-3 py-1.5 rounded-full border border-accent/10"
                  >

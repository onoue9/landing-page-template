...
const Hero: React.FC = () => {
  return (
    <section className="relative pt-28 pb-12 sm:pt-48 sm:pb-40 mesh-gradient overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-4 grid lg:grid-cols-12 gap-8 sm:gap-12 items-center">
        <div className="lg:col-span-7 text-center lg:text-left order-2 lg:order-1">
          ...
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-extrabold text-slate-900 leading-[1.15] sm:leading-[1.1] mb-6 tracking-tight">
          ...
          <div className="mt-10 sm:mt-12 flex flex-wrap items-center justify-center lg:justify-start gap-5 sm:gap-8 opacity-60">
        ...
        <div className="lg:col-span-5 relative order-1 lg:order-2 px-6 sm:px-0">
          <div className="absolute inset-0 bg-blue-600/10 blur-[80px] rounded-full -z-10"></div>
          <div className="relative z-10">
            <img 
              src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&q=80&w=1000" 
              alt="Atendimento Médico" 
              className="rounded-[2rem] sm:rounded-[2.5rem] shadow-2xl border-4 sm:border-8 border-white object-cover aspect-[4/3] lg:aspect-auto"
            />
            <div className="absolute -bottom-4 -left-4 sm:-top-6 sm:-right-6 glass-card p-4 sm:p-6 rounded-2xl sm:rounded-3xl shadow-xl border border-white/50">

    ...
    <section className="py-16 sm:py-24 bg-surface border-y border-accent/5" aria-labelledby="operators-heading">
      <div className="max-w-7xl mx-auto px-6 sm:px-4">
        <AnimatedSection className="text-center mb-10 sm:mb-16">
          <h2 id="operators-heading" className="text-xl sm:text-3xl font-black text-accent mb-2 sm:mb-4 tracking-tight uppercase">
            {operators.title}
          </h2>
        ...
        <AnimatedSection delay={150}>
          <ul
            className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 sm:gap-10 items-center justify-items-center"
            role="list"
          ...
          >
            {operators.items.map((op) => (
              ...
              >
                <div className="flex items-center justify-center grayscale opacity-50 group-hover:grayscale-0 group-hover:opacity-100 group-hover:scale-110 transition-all duration-500">

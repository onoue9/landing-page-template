        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <nav aria-label="Links rápidos">
            ...
            <ul className="space-y-4 text-slate-600">
              ...
              <li><a href="#planos" className="hover:text-blue-600 transition-colors">Tipos de Planos</a></li>
              <li><a href="#contato" className="hover:text-blue-600 transition-colors">Solicitar Cotação</a></li>
            </ul>
          </nav>
          ...
          <nav aria-label="Links legais">
            ...
            <ul className="space-y-4 text-slate-600">
              ...
              <li><a href="/privacidade" className="hover:text-blue-600 transition-colors">Termos de Uso</a></li>
              <li><a href="/privacidade" className="hover:text-blue-600 transition-colors">LGPD</a></li>
            </ul>
          </nav>
        </div>

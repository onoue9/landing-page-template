...
const { site, content, theme } = demoConfigs.imoveis;
...
export default function ImoveisPreviewClient() {
  ...
  const ctaMessage = encodeURIComponent(
    `Olá! Testei o preview da landing page de imóveis e gostei.\n\nDados da minha imobiliária:\n- Nome: ${fields.namePrefix}${fields.nameHighlight}\n- WhatsApp: ${fields.whatsapp}\n- E-mail: ${fields.email}\n\nPodemos conversar?`
  );
    ...
    <div className="flex h-screen overflow-hidden bg-slate-100" style={{ fontFamily: 'sans-serif' }}>
      ...
      <aside className={[
        ...
        <nav className="flex items-center gap-1 px-4 py-2 border-b border-slate-100">
          ...
          <a href="/demo/imoveis" className="text-[11px] font-semibold text-slate-400 hover:text-slate-600 transition-colors whitespace-nowrap">
            Imóveis
          </a>
          <ChevronRight className="w-3 h-3 text-slate-300 shrink-0" />
        ...
        <div className="px-4 py-3 border-b border-slate-100 flex items-center justify-between">
          <div>
            ...
            <p className="text-[10px] text-slate-400">Imobiliária · Edite ao vivo</p>
          </div>
          <button
            onClick={resetAll}
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-6">
          <FormSection title="Imobiliária">
            <div className="grid grid-cols-2 gap-2">
              <Field label="Prefixo" value={fields.namePrefix} onChange={set('namePrefix')} placeholder="Lar" />
              <Field label="Destaque" value={fields.nameHighlight} onChange={set('nameHighlight')} placeholder="Ideal" />
            </div>
            <Field label="Slogan" value={fields.tagline} onChange={set('tagline')} />
            <Field label="WhatsApp (DDI+número)" value={fields.whatsapp} onChange={set('whatsapp')} placeholder="5511999999999" />
        ...
        <div className="flex-1 overflow-auto bg-slate-200 p-4">
          ...
          >
            <iframe
              ...
              ref={iframeRef}
              src="/demo/imoveis"
              title="Preview da landing page de imóveis"
